...
VALUES ('lab 0', 'Lab 0 - Syntax Review: .', 'static/images/lab0.jpg', 'labs', 'static/labs/lab0.zip');

INSERT into `inventory` (`item_name`, `info`, `image_url`, `category`, 'item_file')
VALUES ('lab 1', 'Lab 1 - Responce Reader.', 'static/images/lab1.jpg', 'labs', 'static/labs/lab1.zip');

INSERT into `inventory` (`item_name`, `info`, `image_url`, `category`, 'item_file')
VALUES ('lab 2', ' Lab 2 - Key Collection.', 'static/images/lab2.jpg', 'labs', 'static/labs/lab2.zip');

INSERT into `inventory` (`item_name`, `info`, `image_url`, `category`, 'item_file')
VALUES ('lab 3', 'Lab 3 - Py Game GUI.',  'static/images/lab3.jpg', 'labs', 'static/labs/lab3.zip');

INSERT into `inventory` (`item_name`, `info`, `image_url`, `category`, 'item_file')
VALUES ('lab 4', 'Lab 4 - Git and Paired Programming.', 'static/images/lab4.jpg', 'labs', 'static/labs/lab4.zip');

INSERT into `inventory` (`item_name`, `info`, `image_url`, `category`, 'item_file')
VALUES ('lab 5', 'Lab 5 - Invoice Tests.', 'static/images/lab5.jpg', 'labs', 'static/labs/lab5.zip');
